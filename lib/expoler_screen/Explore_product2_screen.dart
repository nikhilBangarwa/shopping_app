...
class ProductExploreScreen extends StatefulWidget {
  ...
  @override
  State<ProductExploreScreen> createState() => _ProductExploreState();
}
class _ProductExploreState extends State<ProductExploreScreen> {
  List<MultipleList> list = [
    ...
    MultipleList(
      title: 'BLUCAPS Solid Sports/Regular Cap Pack of 2',
      image:
